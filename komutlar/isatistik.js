...
exports.run = async (bot, message, args) => {
  ...
  .setColor('RANDOM')
  .setFooter('Pax\'Buyur benim istatistiklerim', bot.user.avatarURL)
  .addField("»**Botun Sahibi**", "<@355629652737392641>  ")
  .addField("»**Geliştirici** ","<@666024828150611989>")
  ...
  .addField("**» Bot Davet**", " [Davet Et](https://discordapp.com/oauth2/authorize?client_id=672428141544865792&scope=bot&permissions=2146958847)", )
  .addField("**» Destek Sunucusu**", " [Sunucumuza Katıl](https://discord.gg/kzGRPY)", )
