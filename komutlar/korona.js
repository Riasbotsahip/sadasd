...
exports.run = async (client, message, args) => {
  ...
  .replace('türkiye', 'TR', 'Türkiye')
  .replace('çin', 'CN', 'Çin')
  .replace('amerika', 'US', 'Amerika')
  .replace('japonya', 'JP', 'Japonya')
  .replace('fransa', 'FR', 'Fransa')
  .replace('norveç', 'NE', 'Norveç')
  .replace('isveç',  'SN', 'İsveç')
  ...
  let ülk = body.countrydata[0].info.title
    ...
    .setTimestamp()
    .setFooter('Pax', client.user.avatarURL);
